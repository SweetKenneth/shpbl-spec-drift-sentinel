...
Explainable detection of material changes in an agent’s behaviour.
...
- [SPEC-agent-behaviour-drift-sentinel.md](./SPEC-agent-behaviour-drift-sentinel.md) — version 1.0 public behavior specification
